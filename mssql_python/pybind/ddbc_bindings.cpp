...
// SQL_SS_TIME2, SQL_SS_XML, SQL_SS_UDT, SQL_DATETIME2, SQL_SMALLDATETIME, SQL_SS_TIMESTAMPOFFSET
// (In Python, SQL_SS_TIMESTAMPOFFSET corresponds to ConstantsDDBC.SQL_DATETIMEOFFSET.)
